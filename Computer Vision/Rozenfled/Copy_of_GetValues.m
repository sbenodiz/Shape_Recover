function [angle_si_Estimate,angle_si_normal,angle_si,Vector_Si_estimate,Vector_Si_norm,Vector_Si] = GetValues( a,b,c,s,pMiror1,pMiror2,pmonitor1,pmonitor2,K,Points3DScreen)
...
alpha_mReal=GetAngle(om_i,Xm_i+om_i,pmonitor3D1,pmonitor3D2);
