function [ Points3D ] = Get3DpointSurface_For_NewFlatMirror( RealPoints,ImagePoints,InverseRTranspose,name)
M=zeros(8,9);
...
Points3D(1,:)=[O;1]';
Points3D(2,:)=[O + multipleAdd*r1*RealPoints(3,1);1]';
Points3D(3,:)=[((Points3D(2,1:3)') +multipleAdd* r2*RealPoints(4,2));1]';
Points3D(4,:)=[O + multipleAdd*r2*RealPoints(4,2);1]';
