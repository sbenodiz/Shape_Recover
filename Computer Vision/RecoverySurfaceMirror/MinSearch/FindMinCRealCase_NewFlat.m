...
load('data_good_flat_new');

ImagePointsScreen=[ImagePointsScreen(1,:);ImagePointsScreen(4,:);ImagePointsScreen(6,:);ImagePointsScreen(7,:)];
 [bestValueScreen]=fminsearch(@(args) MinFunc(args,K,ImagePointsScreen,RealPointsScreen,multipleAdd),[37,0.1,1,0.1]);
 [bestValueMirror]=fminsearch(@(args) MinFunc(args,K,ImagePointsMirror,RealPointsMirror,multipleAdd),[71,0,0,0]);
...
for i=1:size(Points3DScreen,1)-1
...
save('3dPoints_flat','Points3DScreen','Points3DMirror');
