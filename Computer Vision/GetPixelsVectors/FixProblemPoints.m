...
%find maybe another combination of the neighborhoods is better
%return new MapAllPixel with the correct pixels , oldProblemPoint- All the points that have been change
