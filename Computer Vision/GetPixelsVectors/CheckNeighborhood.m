...
%check for problem points from "MapAllPixel" , check in the WindowsSize and
%check if all the neigboord are like the current pixel, if not add the
%source pixel to the "problemPoints"
problemPoints=[];
